...
class Todo: Object, Identifiable {
    ...
    convenience init(superId: ObjectId? = nil, title: String, memo: String? = nil, priority: Int? = nil, modifiedDate: Date? = Date(), startDate: Date? = nil, dueDate: Date? = nil, isCompleted: Bool = false, estimatedPomodoroMinutes: Int? = nil, isDeleted: Bool = false) {
        self.init()
